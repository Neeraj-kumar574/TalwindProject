...
const Trans = () => {
  return (
    ...
    <div className='grid grid-cols-1 py-5'>
            <p className='text-sm text-orange-500 py-3'>EXPLORE OUR BLOGS</p>
            <h2 className='text-3xl font-bold'>Accelerate Digital Transformation</h2>
        </div>
    <div className='p-10 gap-10 grid grid-flow-row grid-cols-3'>
        
        <div className=' col-4 text-justify'>
            <div className=' w-full'><img className='' src={Image1} alt="" />
            <p className='text-sm text-gray-500 py-2'>Prabhash Mishra • 1 Jan 2023 • Today</p>
            <h2 className='text-lg font-bold py-2'>Small business & Startup </h2>
       ...
       <div className=' col-4 gap-4 text-justify'>
            ...
            <h2 className='text-lg font-bold py-2'>Scale-Up Company Offer</h2>
       ...
       <div className=' col-4 gap-4 text-justify'>
            ...
            <h2 className='text-lg font-bold py-2'>Growing Business Package</h2>
    ...
    <div className=' py-5'>
            <button className='bg-blue-950 px-6 flex justify-center items-center m-auto gap-3 py-2 rounded-xl text-slate-100 '>Show more blogs<FaArrowRight /></button>
         </div>
    </>
  )
}
